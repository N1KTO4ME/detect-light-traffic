...
Проект предназначен для обучения и демонстрации базовых навыков обработки изображений

Алгоритм ищет раму светофора, выделяет лампы и определяет цвет активного сигнала.  
Результат можно выводится в браузере и можно скачать обработанное изображение.

!Проект на стадии демо, допустима неккоректная работа!
